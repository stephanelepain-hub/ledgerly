...
const styles = StyleSheet.create({
  ...
  emptyCamera: { alignItems: "center", justifyContent: "center", padding: 32, gap: 8 }, emptyTitle: { fontSize: 18, lineHeight: 24, fontWeight: "800" }, emptyBody: { fontSize: 13, lineHeight: 19, textAlign: "center", alignSelf: "stretch", maxWidth: 250 },
  ...
  sectionList: { borderWidth: 1, borderRadius: 14, padding: 10, flexDirection: "row", flexWrap: "wrap", gap: 10 }, sectionThumbWrap: { width: 56 }, sectionThumb: { width: 56, height: 74, borderWidth: 1, borderRadius: 9 }, sectionThumbLabel: { marginTop: 2, fontSize: 10, lineHeight: 14, fontWeight: "800", textAlign: "center", alignSelf: "stretch" }, sectionRemove: { position: "absolute", top: -7, right: -7, width: 24, height: 24, borderRadius: 12, borderWidth: 1, alignItems: "center", justifyContent: "center" },
