...
const styles = StyleSheet.create({
  ...
  amountInput: { minWidth: 135, maxWidth: 280, fontSize: 48, lineHeight: 58, fontWeight: "800", letterSpacing: -1.5, textAlign: "center", alignSelf: "stretch", fontVariant: ["tabular-nums"], paddingVertical: 0 },
  group: { gap: 10 },
  ...
  footerNote: { fontSize: 11, lineHeight: 15, textAlign: "center", alignSelf: "stretch" },
